...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Hipek = function Hipek(xCord, yCord, spaceSize) {\n    var _this = this;\n\n    _classCallCheck(this, Hipek);\n\n    this.wakeUp = function (space) {\n        _this.isActive = true;\n        _this.space = space;\n    };\n\n    this.draw = function () {\n        var canvas = document.getElementById('canvas');\n        var ctx = canvas.getContext('2d');\n\n        var hipekIteratorElem = document.querySelector('[data-hipek-iterator]');\n        hipekIteratorElem.innerHTML = _this.iterator;\n\n        ctx.fillStyle = \"rgb(\" + 255 + \",\" + 0 + \",\" + 0 + \")\";\n        ctx.fillRect(_this.x, _this.y, 1, 1);\n    };\n\n    this.initSearch = function () {\n        var initStepInput = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 15;\n\n\n        var initStep = initStepInput;\n\n        var neighbors = _this.getNeigbors();\n        var bestNeighbor = _this.getBestSearchInPointArray(neighbors);\n\n        _this.lookedPoint.push({ x: bestNeighbor.x, y: bestNeighbor.y, val: bestNeighbor.val });\n        _this.iterator++;\n\n        // Move to step point\n        if (_this.x < _this.spaceSize - initStep) {\n            _this.x += initStep;\n        } else if (_this.x >= _this.spaceSize - initStep) {\n            _this.y += initStep;\n            _this.x = initStep;\n        }\n\n        if (_this.lookedPoint.length == 1) {\n            M.toast({ html: 'I start initial search' });\n        }\n        if (_this.y >= _this.spaceSize - initStep) {\n            _this.y = initStep;\n            M.toast({ html: 'I finish initial search' });\n            _this.isInitialSearchFinished = true;\n        }\n    };\n\n    this.getCurrentValue = function () {\n        return _this.space[_this.x][_this.y];\n    };\n\n    this.getBestSearchInPointArray = function (pointArray) {\n        var bestPoint = pointArray[0];\n        pointArray.forEach(function (elem) {\n            if (elem.val > bestPoint.val) {\n                bestPoint = elem;\n            }\n        });\n        return bestPoint;\n    };\n\n    this.getNeigbors = function () {\n        var xCoord = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _this.x;\n        var yCoord = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _this.y;\n\n        var neighbors = [];\n        var i = xCoord;\n        var j = yCoord;\n\n        neighbors.push({ x: i - 1, y: j - 1, val: _this.space[i - 1][j - 1] });\n        neighbors.push({ x: i - 1, y: j, val: _this.space[i - 1][j] });\n        neighbors.push({ x: i - 1, y: j + 1, val: _this.space[i - 1][j + 1] });\n\n        neighbors.push({ x: i, y: j - 1, val: _this.space[i][j - 1] });\n        neighbors.push({ x: i, y: j + 1, val: _this.space[i][j + 1] });\n\n        neighbors.push({ x: i + 1, y: j - 1, val: _this.space[i + 1][j - 1] });\n        neighbors.push({ x: i + 1, y: j, val: _this.space[i + 1][j] });\n        neighbors.push({ x: i + 1, y: j + 1, val: _this.space[i + 1][j + 1] });\n\n        return neighbors;\n    };\n\n    this.bestNeighborValue = function () {\n        var neighbors = _this.getNeigbors();\n        var bestNeighbor = _this.getBestSearchInPointArray(neighbors);\n\n        return bestNeighbor;\n    };\n\n    this.heuristicSearch = function () {\n\n        if (!_this.isClimbing && _this.isActive && _this.lookedPoint.length == 0) {\n            console.log(\"Looked points is empty!\");\n            _this.isInitialSearchFinished = false;\n            _this.x = 10;\n            _this.y = 10;\n        }\n\n        if (!_this.isClimbing && _this.isActive && _this.lookedPoint.length > 0) {\n            var bestPoint = _this.getBestSearchInPointArray(_this.lookedPoint);\n            _this.bestLookedPoint = bestPoint;\n            _this.move(bestPoint.x, bestPoint.y);\n            _this.isClimbing = true;\n            M.toast({ html: 'Go to best looked point to (' + bestPoint.x + ',' + bestPoint.y + ')' });\n        } else {\n            var nextPoint = _this.bestNeighborValue();\n            _this.move(nextPoint.x, nextPoint.y);\n\n            if (_this.space[_this.x][_this.y] == 75) {\n                _this.isClimbing = false;\n                var closePoint = _this.bestNeighborValue();\n\n                if (closePoint.val < nextPoint.val) {\n                    _this.lookedPoint = _this.lookedPoint.filter(function (elem) {\n                        return elem.x != _this.bestLookedPoint.x && elem.y != _this.bestLookedPoint.y;\n                    });\n                    _this.lookedPoint = _this.lookedPoint.filter(function (elem) {\n                        return elem.x != _this.x && elem.y != _this.y;\n                    });\n                    M.toast({ html: 'Found local maximum (' + nextPoint.x + ',' + nextPoint.y + ')=' + Math.round(nextPoint.val) });\n                }\n            }\n\n            if (_this.space[_this.x][_this.y] > 99) {\n                _this.lookedPoint[0] = nextPoint;\n                M.toast({ html: 'Found MAX source (' + nextPoint.x + ',' + nextPoint.y + ')=' + Math.round(nextPoint.val), classes: 'green' });\n                _this.finishSearch(true);\n            }\n        }\n    };\n\n    this.finishSearch = function (status) {\n        _this.isFinish = true;\n\n        if (!status) {\n            console.log(\"Can\\'t find max value\");\n        }\n    };\n\n    this.move = function (x, y) {\n        _this.x = x;\n        _this.y = y;\n        _this.iterator++;\n    };\n\n    this.x = xCord;\n    this.y = yCord;\n    this.spaceSize = spaceSize;\n    this.iterator = 0;\n    this.isActive = false;\n    this.isInitialSearchFinished = false;\n    this.isClimbing = false;\n    this.isFinish = false;\n    this.space = null;\n    this.lookedPoint = [];\n    this.bestLookedPoint = null;\n};\n\nvar Poisson = function Poisson(size, srcCount) {\n    var dynamicFlag = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;\n\n    _classCallCheck(this, Poisson);\n\n    _initialiseProps.call(this);\n\n    this.size = size;\n    this.sourceCounter = srcCount;\n    this.iterationCounter = 0;\n    this.sources = this.initSources(size, srcCount);\n    this.canvas = {};\n    this.isDynamic = dynamicFlag;\n    this.space = this.initSpace(size);\n    this.hipek = new Hipek(10, 10, size);\n    this.hipekWakeUpIteration = 1000; // start move after X iteration\n    this.animationId = null;\n}\n\n// Laplace operator\n;\n\nvar _initialiseProps = function _initialiseProps() {\n    var _this2 = this;\n\n    this.initHipek = function () {\n        _this2.hipek = new Hipek(20, 30);\n    };\n\n    this.initSpace = function (size) {\n        var arr = [];\n        for (var x = 0; x < size; x++) {\n            arr[x] = new Float32Array(size);\n            for (var y = 0; y < size; y++) {\n                arr[x][y] = 0;\n            }\n        }\n        return arr;\n    };\n\n    this.initSources = function (size, srcCount) {\n        var sourcePoints = [];\n\n        // sourcePoints[0] = this.makePoint(68,68,75);\n        // sourcePoints[1] = this.makePoint(20,20,75);\n        // sourcePoints[2] = this.makePoint(40,40,75);\n        // sourcePoints[3] = this.makePoint(60,60,100);\n        // sourcePoints[4] = this.makePoint(80,80,75);\n\n        sourcePoints[0] = _this2.randPoint(100);\n        sourcePoints[1] = _this2.randPoint(75);\n        sourcePoints[2] = _this2.randPoint(75);\n        sourcePoints[3] = _this2.randPoint(75);\n        sourcePoints[4] = _this2.randPoint(75);\n\n        return sourcePoints;\n    };\n\n    this.randPoint = function (value) {\n        var x = Math.floor(Math.random() * Math.floor(_this2.size));\n        var y = Math.floor(Math.random() * Math.floor(_this2.size));\n\n        if (x <= 3 || x >= _this2.size - 3 || y <= 3 || y >= _this2.size - 3) {\n            return _this2.randPoint(value);\n        }\n\n        return { x: x, y: y, val: value };\n    };\n\n    this.makePoint = function (x, y, val) {\n        return { x: x, y: y, val: val };\n    };\n\n    this.setStaticSources = function () {\n        _this2.sources.forEach(function (element) {\n            _this2.space[element.x][element.y] = element.val;\n        });\n    };\n\n    this.moveSources = function (point) {\n        var movedPoint = point;\n        var randMove = Math.floor(Math.random() * Math.floor(4));\n\n        if (randMove === 0 && movedPoint.x > 1) {\n            // left\n            movedPoint.x--;\n        } else if (randMove === 1 && movedPoint.x < _this2.size - 2) {\n            // right\n            movedPoint.x++;\n        } else if (randMove === 2 && movedPoint.y > 1) {\n            // top\n            movedPoint.y--;\n        } else if (randMove === 3 && movedPoint.y < _this2.size - 2) {\n            // bottom\n            movedPoint.y++;\n        } else {\n            _this2.moveSources(point);\n        }\n\n        return movedPoint;\n    };\n\n    this.calculate = function () {\n        var SIZE = _this2.size;\n        for (var i = 1; i < SIZE - 1; i++) {\n            for (var j = 1; j < SIZE - 1; j++) {\n                _this2.setStaticSources();\n                _this2.space[i][j] = (_this2.space[i + 1][j] + _this2.space[i - 1][j] + _this2.space[i][j - 1] + _this2.space[i][j + 1]) * 0.25;\n                if (_this2.space[i][j] < 0.01) {\n                    _this2.space[i][j] = 0;\n                };\n            }\n        }\n    };\n\n    this.normalize = function (val) {\n        var max = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 100;\n        var min = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;\n        return (val - min) / (max - min) * 255;\n    };\n\n    this.iteration = function () {\n        var iterCounter = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;\n\n        if (!_this2.hipek.isFinish) {\n            for (var i = 0; i < iterCounter; i++) {\n                _this2.calculate();\n                _this2.iterationCounter++;\n                if (_this2.isDynamic && _this2.iterationCounter % 10 == 0) {\n                    for (var srcCount = 0; srcCount < _this2.sources.length; srcCount++) {\n                        _this2.sources[srcCount] = _this2.moveSources(_this2.sources[srcCount]);\n                    }\n                }\n\n                if (_this2.iterationCounter > _this2.hipekWakeUpIteration) {\n                    if (!_this2.hipek.isActive) {\n                        _this2.hipek.wakeUp(_this2.space);\n                    }\n\n                    if (!_this2.hipek.isInitialSearchFinished) {\n                        _this2.hipek.initSearch();\n                    } else {\n                        _this2.hipek.heuristicSearch();\n                    }\n                }\n\n                if (_this2.hipek.iterator > 250) {\n                    _this2.stopAnimation();\n                    _this2.hipek.finishSearch(false);\n                }\n                if (_this2.hipek.isFinish) {\n                    _this2.stopAnimation();\n                }\n            }\n\n            _this2.drawSpace();\n            _this2.viewIterationBadge();\n            _this2.hipek.draw();\n        }\n    };\n\n    this.playAnimation = function () {\n        _this2.animationId = setInterval(_this2.iteration, 500);\n    };\n\n    this.stopAnimation = function () {\n        clearInterval(_this2.animationId);\n    };\n\n    this.setDynamicSourceStatus = function (status) {\n        _this2.isDynamic = status;\n    };\n\n    this.viewIterationBadge = function () {\n        var badge = document.querySelector('[data-iteration-counter]');\n        badge.innerHTML = '' + _this2.iterationCounter;\n    };\n\n    this.drawSpace = function () {\n        var canvas = document.getElementById('canvas');\n        var ctx = canvas.getContext('2d');\n\n        var colorArr = [];\n        var SIZE = _this2.size;\n\n        for (var i = 0; i < SIZE; i++) {\n            colorArr[i] = new Int16Array(100);\n            for (var j = 0; j < SIZE; j++) {\n                var arrValue = _this2.space[i][j];\n                var greyScale = 0;\n                if (arrValue > 90) {\n                    greyScale = 255;\n                } else if (arrValue > 70) {\n                    greyScale = 168;\n                } else if (arrValue > 50) {\n                    greyScale = 144;\n                } else if (arrValue > 10) {\n                    greyScale = 128;\n                } else if (arrValue > 4) {\n                    greyScale = 64;\n                } else if (arrValue > 1) {\n                    greyScale = 32;\n                } else if (arrValue > 0.1) {\n                    greyScale = 12;\n                }\n\n                colorArr[i][j] = _this2.normalize(arrValue);\n                greyScale = _this2.normalize(arrValue);\n\n                ctx.fillStyle = \"rgb(\" + greyScale + \",\" + greyScale + \",\" + greyScale + \")\";\n                ctx.fillRect(i, j, 1, 1);\n            }\n        }\n    };\n};\n\nexports.default = Poisson;\n\n//# sourceURL=webpack:///./src/poisson.js?");
